...
class App extends Component {
    ...
    Vote1=(e)=>{
        ...
        if(this.state.vote === 0){
            ...
            axios.put(`https://server-musicbattle.herokuapp.com/api/music/name/${RoomName}`,{vote1:1})
            this.setState({
                vote:1
            })
        }
    ...
    Vote2=(e)=>{
        ...
        if(this.state.vote === 0){
            ...
            axios.put(`https://server-musicbattle.herokuapp.com/api/music/name/${RoomName}`,{vote2:1})
            this.setState({
                vote:1
            })
        }
